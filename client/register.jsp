...
<script type="text/javascript">
	function changeImage(){
		var changes = document.getElementById("img");
		/*${pageContext.request.contextPath}*/
		changes.src = "${pageContext.request.contextPath}/CheckImgServlet?time=" + new Date().getTime();
	}
</script>
</head>
<body class="main">
			...
			<table width="850px" border="0" cellspacing="0">
				<tr>
					<td style="padding: 30px"><h1>新用户注册</h1>
						...
						<h1>注册验证</h1>
						<table width="80%" boder="0" cellspacing="2" class="upline">
							<tr>
								<td style="text-align: right;width: 20%">输入验证码:</td>
								<td style="width: 50%">
									<input type="text" class="textinput" name="Code">
									<span>${requestScope.codeerror}</span>
								</td>
								<td>&nbsp</td>
							</tr>
							<tr>
								<td style="text-align: right; width: 20%">&nbsp</td>
								<td rowspan="2" style="width: 50%">
									<img alt="" src="<%=request.getContextPath()%>/ValidateColorServlet" width="100"
